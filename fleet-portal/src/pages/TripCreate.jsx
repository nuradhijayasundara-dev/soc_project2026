...
import { Box, Typography, Paper, Grid, TextField, MenuItem, Button, Alert } from '@mui/material';
...
export default function TripCreate() {
  ...
  return (
    <Box>
      <Typography variant="h5" fontWeight={700} gutterBottom>Create Trip</Typography>
