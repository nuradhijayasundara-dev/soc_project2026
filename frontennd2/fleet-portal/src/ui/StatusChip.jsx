...
const TONES = {
  ...
  ON_TRIP: { fg: '#0284C7', bg: 'rgba(2,132,199,0.12)' },
  IN_PROGRESS: { fg: '#0284C7', bg: 'rgba(2,132,199,0.12)' },
  OFF_DUTY: { fg: '#94A3B8', bg: 'rgba(148,163,184,0.16)' },
  MAINTENANCE: { fg: '#D97706', bg: 'rgba(217,119,6,0.14)' },
