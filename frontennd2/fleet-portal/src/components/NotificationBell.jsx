...
// The Fleet Portal only ever receives BOOKING_ACCEPTED/REJECTED style events
// today (courier-side events like MATCH_FOUND/SHIPMENT_STATUS never target a
// fleet manager), but this stays generic in case that changes.
const linkFor = (n) => {
  switch (n.type) {
    case 'BOOKING_REQUESTED':
    case 'BOOKING_ACCEPTED':
    case 'BOOKING_REJECTED': return '/bookings';
    default: return null;
  }
};
