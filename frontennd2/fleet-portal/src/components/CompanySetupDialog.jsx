...
/**
 * Fleet-company onboarding. A fleet manager must register their company before
 * the Dashboard, trucks, drivers and availability work — every /fleet/**
...
export default function CompanySetupDialog({ open, onClose, onSaved }) {
  ...
  return (
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="sm">
      <DialogTitle>Set up your fleet company</DialogTitle>
      <form onSubmit={handleSubmit}>
        <DialogContent>
          <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
            You need a fleet company profile before registering trucks, drivers or availability.
          </Typography>
