...
/**
 * Fires in-app notifications by calling notification-service directly
 * (Eureka name), never through the Gateway. Failures here are swallowed —
 * a notification going missing should never block the underlying business
 * action (matching, accepting, rejecting).
 */
@Component
