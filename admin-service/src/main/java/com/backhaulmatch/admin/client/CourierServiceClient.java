...
/**
 * Reads courier-service's internal admin endpoints (Eureka name) for the
...
public class CourierServiceClient {
    ...
    private static final String BASE_URL = "http://COURIER-SERVICE/internal/admin/companies";
